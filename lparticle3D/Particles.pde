class Particle {
  ...
  void move() {
    ...
    float distance = dist(this.pos.x, this.pos.y,this.pos.z, this.target.x, this.target.y,this.target.z);
    if (distance < this.closeEnoughTarget) {
      proximityMult = distance/this.closeEnoughTarget;
    }

    // Add force towards target
    PVector towardsTarget = new PVector(this.target.x, this.target.y,this.target.z);
